...
REGISTRY = [
    ...
    },
    {
        ...
        "name":    "OD Matrix: B-zone → School B-zone",
        "rq":      "RQ1",
        "desc":    "Spatial clustering: from which home zones do students travel to which school zones",
        "inputs":  ["school_trips_los.csv"],
        "outputs": ["(none yet)"],
        "status":  "pending",
        "key_result": "",
        "notes":   "Listed in RQ1 'Analyses planned' — data ready, script not written",
    },
    {
        "id":      "A5",
